...
class Policy(nn.Module):
    ...
    def __init__(self):
        ...
        torch.nn.init.xavier_uniform_(self.input_layer[1].weight)
        torch.nn.init.xavier_uniform_(self.output_policy[0].weight)
        torch.nn.init.xavier_uniform_(self.output_value[0].weight)
    ...
    def calculate_loss(self, gamma=0.999):
        ...
        for r, s in zip(returns, saved_actions):
            policy_losses.append(-g * s.log_prob * (r - s.value))
            g = g * gamma
